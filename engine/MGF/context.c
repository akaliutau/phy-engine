...
#ifndef lint
static const char SCCSid[] = "@(#)context.c 1.24 2/12/97 LBL";
#endif
...
static LUTAB	mat_tab = LU_SINIT(free,free);	
static LUTAB	vtx_tab = LU_SINIT(free,free);	
...
static int	setspectrum(register C_COLOR *clr, double wlmin, double wlmax, int ac, char **av);
static int	setbbtemp(register C_COLOR *clr, double tk);
static void	mixcolors(register C_COLOR *cres, double w1, register C_COLOR *c1, double w2, register C_COLOR *c2);


int
c_hcolor(int ac, register char **av)		
...
int
c_hmaterial(int ac, register char **av)		
...
int
c_hvertex(int ac, register char **av)		
...
void
c_ccvt(register C_COLOR *clr, int fl)			
...
static int
setspectrum(register C_COLOR *clr, double wlmin, double wlmax, int ac, char **av)	
...
static void
mixcolors(register C_COLOR *cres, double w1, register C_COLOR *c1, double w2, register C_COLOR *c2)	
...
static int
setbbtemp(register C_COLOR *clr, double tk)		
