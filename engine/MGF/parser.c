...
#ifndef lint
static const char SCCSid[] = "@(#)parser.c 1.24 3/18/97 LBL";
#endif
...
static int	e_any_toss(int ac, char **av),		
		e_ies(),		
...
{
	static LUTAB	ent_tab = LU_SINIT(NULL,NULL);	
	register char	*cp;
...
int
mg_handle(register int en, int ac, char **av)		
...
int
mg_open(register MG_FCTXT *ctx, char *fn)			
...
void
mg_fgetpos(register MG_FPOS *pos)			
